...
* application
*/
function ParentPostDAO(database) {
"use strict";
...
this.getCategories = function(callback) {
    ...
    */
    ...
    this.db.collection('parentPost').aggregate([
...
this.getParentPost = function(category, page, itemsPerPage, callback) {
    "use strict";
    ...
    this.db.collection('parentPost').find(queryDoc)
                                .limit(itemsPerPage)
...
this.getNumParentPost = function(category, callback) {
    "use strict";
    ...
    this.db.collection('parentPost').find(queryDoc).count(function(err, count) {
        if (err) throw err;
        callback(count);
    });
}
...
this.searchParentPost = function(query, page, itemsPerPage, callback) {
    "use strict";
...
this.getNumSearchParentPost = function(query, callback) {
    "use strict";
...
this.getParentPost= function(itemId, callback) {
    "use strict";
    ...
    this.db.collection('parentPost').find(queryDoc).limit(1).next(function(err, item) {
        assert.equal(err, null);
        callback(item);
    });
}
...
this.getRelatedParentPost = function(callback) {
    "use strict";

    this.db.collection("parentPost").find({})
        .limit(4)
...
this.addReview = function(itemId, comment, name, stars, callback) {
    ...
    this.db.collection('parentPost').updateOne(filterDoc, updateDoc, function(err, item) {
        assert.equal(err, null);
        callback(item);
    })
}
...
this.createDummyParentPost = function() {
    "use strict";
...
module.exports.ParentPostDAO = ParentPostDAO;